...
namespace Services
{
    ...
    {        
        //Services injected
        private ILogger<csFriendsServiceOther1> _logger = null;

        //random seeding
        private const string _seedSource = "./other1-seeds.json";
        ...
        public csFriendsServiceOther1(ILogger<csFriendsServiceOther1> logger):this()
        {
            _logger = logger;

            //Logging examples at various levels
            _logger.LogInformation(_instanceHeartbeat); 
            _logger.LogWarning(_instanceHeartbeat); 
            _logger.LogError(_instanceHeartbeat); 
            _logger.LogCritical(_instanceHeartbeat); 
        }
        #endregion
